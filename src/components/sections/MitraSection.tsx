        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-xl text-white leading-relaxed">
              ...
              dari tim kami, Anda dapat menawarkan layanan Umrah dan pariwisata
              internasional berkualitas tinggi kepada jamaah di komunitas Anda.
            </p>
          </div>
        </div>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-gray-200">{office.phone}</p>
                </div>
              </div>
            </div>
          ))}
